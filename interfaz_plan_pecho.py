...
class Ventana9_2(QMainWindow):

    def __init__(self,anterior):
        super(Ventana9_2, self).__init__(anterior)
        ...
        self.letrero1.setText("Dia de Pecho")
        ...
        self.listamusculos = ["Tríceps", "Pecho", "Hombro"]
        self.imagenesmusculos = ['imagenes/triceps.png','imagenes/pecho.png',
                                 'imagenes/hombro.png']
