...
class Ventana9_3(QMainWindow):

    def __init__(self,anterior):
        super(Ventana9_3, self).__init__(anterior)
        ...
        self.letrero1.setText("Día de Espalda")
        ...
        self.listamusculos = ["Espalda", "Biceps",
                              "Antebrazo","Abdomen"]
        self.imagenesmusculos = ['imagenes/espalda.png', 'imagenes/biceps.png',
                                 'imagenes/antebrazo.png','imagenes/abdomen.png']
